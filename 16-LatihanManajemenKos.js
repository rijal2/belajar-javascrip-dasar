    ...
    if( kamar.length == 0 ){
        ...
        for (var i = 0; i < kamar.lenght; i++){
            ...
            // Jika sudah ada nama yang sama
                ...
                console.log("Mohon maaf kamar kos disini mensyaratkan tidak boleh ada nama yang sama. Nama " + namaTamu + "sudah ada yang menempati")
                // Kembalikan isi array dan keluar dari function
                return kamar;
            }
